...
# User input
username = input(f"Enter friend's name: ").strip().upper()
messages_count = int(input(f"Number of unread text messages: "))
is_online = input(f"Are they online right now? (yes/no): ").strip().lower() == "yes"

# Output current status
status_message = "💬 [ b " +username + " ] " + "is typing a response..." 
