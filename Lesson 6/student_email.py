...
id = input("What is your student id? ").strip().lower()

# Srip input to remove accidental spaces and turn names into lowercase (resave in variables)
...
print("Your email address is " + name + last + id +"@school.fakep")
# --------------------------------
