...
shopping_list = ['']
print("Write your shopping cart.")
# MAIN
...
while True:
    ...
    user_items = input("Add an item to the shopping list or type 'done' to complete. ").lower().strip()
    if user_items == 'done':
        break
    else:
        item_price = input("How much does that item cost")
        shopping_list.append(user_items)
        shopping_list.append(item_price)
    # -----------------------------------------------------------------
    # OPTION 1: ADD ITEM 
    # -----------------------------------------------------------------
